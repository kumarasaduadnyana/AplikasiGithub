...
import com.android.usergithub.databinding.FragmentFollowingBinding
...
class Following : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (activity != null){
            adapter = Adapter()
            this.view = ViewModelProvider(this, ViewModelProvider.NewInstanceFactory()).get(
            ...
            context?.let {
                if (username != null) {
                    this.view.getFollowing(username, it)
                }
            }
